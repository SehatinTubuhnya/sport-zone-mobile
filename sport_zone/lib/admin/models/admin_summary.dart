...
AdminSummary adminSummaryFromJson(String str) =>
    AdminSummary.fromJson(json.decode(str));
...
class AdminSummary {
  ...
  factory AdminSummary.fromJson(Map<String, dynamic> json) => AdminSummary(
    ...
    recentLogs: List<RecentLog>.from(
      json["recent_logs"].map((x) => RecentLog.fromJson(x)),
    ),
  );
